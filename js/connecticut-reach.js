...
(function () {
  ...
  var properties = [
    {
      ...
      price: '$1,500,000',
      tone: 'retail',
      image: 'assets/property-37-chase.jpg',
      imageAlt: '37 Chase Avenue in Waterbury',
    ...
    },
    {
      ...
      tone: 'industrial',
      image: 'assets/property-15-nutmeg.jpg',
      imageAlt: '15 Nutmeg Valley Road in Wolcott',
    ...
    },
    {
      ...
      tone: 'medical',
      image: 'assets/property-714-chase.jpg',
      imageAlt: '714 Chase Parkway medical office property',
  ...
  function cardHTML(p) {
    var visual = p.image
      ? '<img src="' + p.image + '" alt="' + (p.imageAlt || p.title) + '" width="710" height="387" />'
      : svgFor(p.tone);
    return [
  ...
  function initMarketMap() {
    ...
    var markets = [
      ...
      ['New Haven', 41.308, -72.927],
      ['Hartford', 41.765, -72.673],
      ['Danbury', 41.394, -73.454],
      ['Stamford', 41.053, -73.538]
    ];
